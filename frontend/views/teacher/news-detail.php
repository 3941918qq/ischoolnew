...
<div class="pull-left" style="margin-left: 10px;width: 70%;min-width: 600px;">
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        ...
        <hr/>
        <p class="text-primary"> <span class="badge" style="background: red;padding: 3px 10px">动态</span><span style="padding: 0 0 0 15px"><?=$newsDetail['title']?></span> <span class="text-right pull-right"><?=$newsDetail['submitTime']?></span></p>
