...
<div class="pull-left" style="margin-left: 10px;width: 70%;min-width: 600px;">
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        ...
        <div style="background-color: #eee;padding: 10px; font-size: 18px;" class="text-center"><?=$school['name']?></div>
        <div class="slide">
            <?php if(!empty($slide)){?>
    ...
    <ul class="list-group" style="background-color: white;padding: 10px 20px;margin-top: 5px;box-shadow: 0 0 2px #ccc;">
        <li style="border: none;line-height: 30px;" class="list-group-item">
            <span class="gg">公告</span><?= !empty($notice)?$notice['title']:"暂无公告信息！";?><?php if(!empty($notice)){ echo Html::a('>>查看详情', ['/manage/notice-detail', 'id' => $notice['id']], ['class' => 'pull-right']);}?>
        </li>
        <li style="border: none;border-top: 1px solid #ddd;line-height: 30px;" class="list-group-item">
            <span style="background-color: #FF9900;" class="gg">动态</span><?= !empty($news)?$news['title']:"暂无动态信息！";?><?php if(!empty($notice)){ echo Html::a('>>查看详情', ['/manage/news-detail', 'id' => $news['id']], ['class' => 'pull-right']);}?>
        </li>
    </ul>
       ...
       <?php foreach($column as $key=>$value){?>
        <div class="zhanshi">
            <div class="xgk clearfix">
                <span class="gg"><?=!empty($value['columnName'])?$value['columnName']:"暂无名称"?></span>
                <?= Html::a('编辑', ['manage/edit-colcontent', 'id' => $value['id']], ['class' => 'pull-right gg','style'=>'line-height: 18px;margin: 7px 15px;']) ?>            
            </div>
            <div>
                    <img class="pull-left" style="max-width: 400px;" src="<?=!empty($value['columnPicture'])?$value['columnPicture']:'/img/zhengfan.png'?>" />
