    ...
    <div style="background-color: white;padding: 10px 20px;box-shadow: 0 0 2px #ccc;">
        ...
        <div>
            <button class="btn btn-sm btn-info">
               <?= Html::a('编辑', ['/manage/add-notice', 'id' => $noticeDetail['id']], ['class' => 'profile-link btn-info']) ?>
            </button>
            <button class="btn btn-sm btn-danger">
              <?= Html::a('删除', ['/manage/del-notice', 'id' => $noticeDetail['id']], ['onclick' => 'return confirm("确定要删除这条公告吗？")','class'=>'btn-danger']) ?>
           </button>
        </div>
    </div>
</div>
