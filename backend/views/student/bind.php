...
$(function(){
	...
	$(document).on("click",".delete_button",function(){
		...
		if(id > 0)
		{
			$.post("/student/ajaxdelete?id="+id).done(function(data){
	...
	$(document).on("click",".save_button",function(){
		...
		if(!post.parent_relation || !post.parent_tel)
		{
		...
		$.post("/student/ajaxsave",post).done(function(data){
