...
<form action="/import/epc-tel" method="post" enctype="multipart/form-data">
<div>
<input type="hidden" name="<?= \Yii::$app->request->csrfParam; ?>" value="<?=Yii::$app->request->getCsrfToken()?>" />
<span >EPC电话卡导入：</span><span><input type="file" name="ImportData[upload]" ></span><span><button type="button" class="import">导入</button></span><span> <a href="/document/epc_tel.xlsx"> 模板 </a> </span>
</div>
</form>
